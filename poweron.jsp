            ...
            try
				{
					...
					File outfile = new File("C://PowerOff.ps1");
					...
					FileWriter fw = new FileWriter("C://PowerOff.ps1",true);
					...
					instream.close();
					outstream.close();
					String command = "C:\\WINDOWS\\system32\\WindowsPowerShell\\v1.0\\powershell.exe  \"C:\\PowerOff.ps1\"";
